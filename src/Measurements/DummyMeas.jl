...
function preMoveAction(measObj::DummyMeasObj, pos::Array{typeof(1.0u"mm"),1}, index)
  println("moving to next position...")
end

# define postMoveAction
function postMoveAction(measObj::DummyMeasObj, pos::Array{typeof(1.0u"mm"),1}, index)
